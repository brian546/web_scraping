...
The project aims to collect data from OpenRice using web scrapping and analyze the the best strategy for running a Japanese restaurant in Hong Kong Island
